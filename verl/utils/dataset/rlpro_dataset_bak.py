...
class RLHFProDataset(Dataset):
    ...
    def _curriculum_params(self):
        ...
        if self.response_mode == "curriculum":
            ...
            self.step_prompt_length = int(self.max_prompt_length + self.max_response_length * progress_ratio)
    ...
    def __getitem__(self, item):
        ...
        if self.processor is not None:
            ...
            sample_length = prompt_length + int(response_length * progress_ratio)
