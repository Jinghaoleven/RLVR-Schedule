...
# MODEL_NAME=/mnt/public/users/zhangjinghao/code/verl/result/LM/qwen3_4b/xcombined-pro-wpg-fk1-advdt-grpo-v0.001/global_step_234/hf
# EXP_NAME=Qwen3-4B-xcombined-pro-wpg-fk1-advdt-grpo-v0.001
MODEL_NAME=/mnt/public/users/zhangjinghao/models/Qwen2.5-7B
EXP_NAME=Qwen2.5-7B

python eval/evaluate_parallel_raw.py \
