...
project_name=qwen3_4b_instruct
experiment_name=QuestA-25-pro-wsft1.0-grpo
...
if [ "${RANK}" == "0" ]; then
    ...
    ray job submit --address="http://$MASTER_ADDR:8265" \
        ...
        data.train_files=$WORKING_DIR/dataset/train/QuestA-25/train.parquet \
        data.val_files=$WORKING_DIR/dataset/eval/aime24-system.parquet \
        ...
        data.max_curriculum_epoch=60 \
        actor_rollout_ref.model.path=$ROOT_DIR/models/Qwen3-4B-Instruct-2507 \
        actor_rollout_ref.actor.optim.lr=1e-6 \
        actor_rollout_ref.model.use_remove_padding=True \
        actor_rollout_ref.actor.ppo_mini_batch_size=256 \
        actor_rollout_ref.actor.ppo_micro_batch_size_per_gpu=2 \
        actor_rollout_ref.actor.use_sft_loss=True \
        actor_rollout_ref.actor.sft_loss_coef=1 \
