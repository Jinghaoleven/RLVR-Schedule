...
def create_rl_dataset(data_paths, data_config, default_local_dir, tokenizer, processor, is_train=True, max_samples: int = -1):
    """Create a dataset.
    ...
    # from verl.utils.dataset.rlpro_dataset_bak import RLHFProDataset
