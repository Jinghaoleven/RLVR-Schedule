...
RM_NUM_WORKERS=2
RM_MAX_PROMPT_LENGTH=12288
RM_MAX_RESPONSE_LENGTH=256
RM_MAX_MODEL_LEN=12288
RM_MAX_BATCHED_TOKENS=16384
RM_MAX_NUM_SEQS=2
...
export FLASHINFER_WORKSPACE_BASE=$WORKING_DIR/.flashinfer
...
python3 -m verl.trainer.main_ppo \
    ...
    reward.num_workers=$RM_NUM_WORKERS \
    ...
    reward.custom_reward_function.reward_kwargs.model_name=$REWARD_MODEL \
    ...
    reward.reward_model.rollout.enable_chunked_prefill=False \
    reward.reward_model.rollout.enable_prefix_caching=False \
    reward.reward_model.rollout.max_model_len=$RM_MAX_MODEL_LEN \
    reward.reward_model.rollout.max_num_batched_tokens=$RM_MAX_BATCHED_TOKENS \
    reward.reward_model.rollout.max_num_seqs=$RM_MAX_NUM_SEQS \
    reward.reward_model.rollout.prompt_length=$RM_MAX_PROMPT_LENGTH \
    reward.reward_model.rollout.response_length=$RM_MAX_RESPONSE_LENGTH \
    +reward.max_concurrent=512 \
    +reward.timeout=300 \
