...
MODEL_NAME=/mnt/public/users/zhangjinghao/code/verl/result/LM/qwen3_4b_new/xcombined-pro-on-policy-acc-grpo-v2/global_step_234/actor
MERGE_PATH=/mnt/public/users/zhangjinghao/code/verl/result/LM/qwen3_4b_new/xcombined-pro-on-policy-acc-grpo-v2/global_step_234/hf
EXP_NAME=Qwen3-4B-xcombined-pro-on-policy-acc-grpo-v2-1.2temp
