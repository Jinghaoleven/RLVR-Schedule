...
experiment_name=xcombined-pro-on-policy-grpo

# export CUDA_VISIBLE_DEVICES=0,1,2,3
export WORKING_DIR=/mnt/public/users/zhangjinghao/code/verl
export TENSORBOARD_DIR=$WORKING_DIR/tensorboard_log
cd /mnt/public/users/zhangjinghao/code/verl-old
...
if [ "${RANK}" == "0" ]; then
    ...
    ray job submit --address="http://$MASTER_ADDR:8265" \
        ...
        data.prompt_strategy=on_policy_prefix \
