...
# MODEL_NAME=/mnt/public/users/zhangjinghao/code/verl/result/LM/qwen3_4b/xcombined-pro-grpo-v2.4/global_step_234/actor
# MERGE_PATH="${MODEL_NAME%/actor}/hf"
# EXP_NAME=Qwen3-4B-xcombined-pro-grpo-v2.4-evalp
