...
STUDENT_MODEL=$ROOT_DIR/models/Qwen3-1.7B
TEACHER_MODEL=$ROOT_DIR/models/Qwen3-4B
...
DISTILLATION=(
    ...
    distillation.teacher_model.inference.max_num_seqs=1024
